...
//ADD product
   if(isset($_POST["added_date"]) AND isset($_POST['product_name'])){
    $obj = new DBOperation();
    $result = $obj->addProduct($_POST["select_cat"],$_POST["select_brand"],$_POST["product_name"],$_POST["product_price"],$_POST["product_qyt"],$_POST["added_date"]);
    echo $result;
    exit();
   }
...
?>
            <tr>
                ...
                <td>
                    <button type="button" did="<?php echo $row['cid']; ?>" class="btn btn-danger del_cat">Delete</button>
                    <button type="button" eid="<?php echo $row['cid']; ?>" class="btn btn-info edit_cat" data-bs-toggle="modal" data-bs-target="#form_update">Edit</button>
                </td>
            </tr>
			...
			?>
				<tr>
			        ...
			        <td>
			        	...
			        	<a href="#" eid="<?php echo $row['bid']; ?>" class="btn btn-info btn-sm edit_brand"  data-bs-toggle="modal" data-bs-target="#form_brand">Edit</a>
			        </td>
			      </tr>
			<?php
			$n++;
			...
			?> 
				<tr>
			        ...
			        <td>
			        	...
			        	<a href="#" eid="<?php echo $row['pid']; ?>" class="btn btn-info btn-sm edit_product" data-bs-toggle="modal" data-bs-target="#form_products">Order</a>
			        </td>
			      </tr>
			<?php
			$n++;
